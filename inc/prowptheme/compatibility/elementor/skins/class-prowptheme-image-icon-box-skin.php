 ...
 */
	...
	class ProWPTheme_Image_Icon_Box_Skin extends Elementor\Skin_Base {
		
		public function __construct( Elementor\Widget_Base $parent ) {
			parent::__construct( $parent );
			add_action( 'elementor/element/polmo-lite-image-icon-box/section_style_content/after_section_start', [ $this, 'register_controls' ] );		
		}
     
		public function get_id() {
			return 'polmo_lite_image_icon_skin';
		}

		public function get_title() {
			return __( 'List style', 'polmo-lite' );
		}
		...
		public function register_controls( $controls ) {
		    ...
		    $controls->add_control( 'general_color',
		        [
			        'label' => __( 'General color', 'polmo-lite' ),
...
add_action( 'elementor/widget/polmo-lite-image-icon-box/skins_init', function( $widget ) {
   $widget->add_skin( new ProWPTheme_Image_Icon_Box_Skin( $widget ) );
} );
