 ...
 */
	...
	class Polmo_Lite_ProWPTheme_Blog_Skin extends Elementor\Skin_Base {
		...
		public function get_id() {
			return 'polmo_lite_blog_skin';
		}

		public function get_title() {
			return __( 'Style 2', 'polmo-lite' );
		}
		...
		$controls->add_control(
			'heading_rm',
			[
				'label' => __( 'Read more link', 'polmo-lite' ),
		...
		$controls->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .polmo-lite-blog .read-more' => 'color: {{VALUE}};',
				],
				'condition' => [
					'_skin' => $this->get_id(),
				],					
		...
		$controls->add_group_control(
			...
			[
				'name' => 'rm_typography',
				'selector' => '{{WRAPPER}} .polmo-lite-blog .read-more',
							...
							<div class="col-md-12">
								<div class="post-item large-post">
									...
									<div class="post-content">	
										...
										<a class="read-more" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php esc_html_e( 'Read more >>', 'polmo-lite' ); ?></a>
									</div>	
								</div>				
							</div>
...
add_action( 'elementor/widget/polmo-lite-blog/skins_init', function( $widget ) {
   $widget->add_skin( new Polmo_Lite_ProWPTheme_Blog_Skin( $widget ) );
} );