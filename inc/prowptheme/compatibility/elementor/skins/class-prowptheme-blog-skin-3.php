 ...
 */
	...
	class ProWPTheme_Polmo_Lite_Blog_Skin_3 extends Elementor\Skin_Base {
		...
		public function get_id() {
			return 'polmo_lite_blog_skin_3';
		}

		public function get_title() {
			return __( 'Style 4', 'polmo-lite' );
		}
...
add_action( 'elementor/widget/polmo-lite-blog/skins_init', function( $widget ) {
   $widget->add_skin( new ProWPTheme_Polmo_Lite_Blog_Skin_3( $widget ) );
} );