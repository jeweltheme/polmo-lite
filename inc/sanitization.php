 ...
 */
function polmo_lite_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function polmo_lite_sanitize_css( $css ) {
 ...
 */
function polmo_lite_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function polmo_lite_sanitize_email( $email, $setting ) {
 ...
 */
function polmo_lite_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function polmo_lite_sanitize_html( $html ) {
 ...
 */
function polmo_lite_sanitize_image( $image, $setting ) {
 ...
 */
function polmo_lite_sanitize_nohtml( $nohtml ) {
 ...
 */
function polmo_lite_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function polmo_lite_sanitize_number_range( $number, $setting ) {
 ...
 */
function polmo_lite_sanitize_select( $input, $setting ) {
 ...
 */
function polmo_lite_sanitize_url( $url ) {
...
function polmo_lite_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}